...
export const EVENTS = {
  ...
  BATCH_MODE_CHANGED: 'BATCH_MODE_CHANGED',
  BATCH_SELECTION_CHANGED: 'BATCH_SELECTION_CHANGED',
  BATCH_DELETE_COMPLETED: 'BATCH_DELETE_COMPLETED',
  BATCH_COMPLETE_COMPLETED: 'BATCH_COMPLETE_COMPLETED',
  BATCH_INCOMPLETE_COMPLETED: 'BATCH_INCOMPLETE_COMPLETED',
